...
export default function Mission() {
  return (
    <>
      ...
      <section className="relative py-20 md:py-32 px-6 md:px-12 lg:px-20 overflow-hidden bg-white font-['Montserrat',ui-sans-serif,system-ui,sans-serif]">
        ...
        <div className="max-w-7xl mx-auto flex flex-col lg:flex-row items-center gap-16 lg:gap-24">
          ...
          <div className="flex-1 text-slate-600">
            ...
            >
              ...
              <h2 className="text-4xl md:text-5xl font-bold text-slate-900 leading-[1.1] mb-8 font-['Montserrat',ui-sans-serif,system-ui,sans-serif]">
            ...
            <div className="space-y-6 text-lg leading-[1.7]">
