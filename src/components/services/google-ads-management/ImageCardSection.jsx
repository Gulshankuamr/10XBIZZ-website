...
const ImageCardSection = () => {
  return (
    <section 
      className="w-full flex items-center justify-center px-4 sm:px-10 -mt-20 md:py-16 bg-white" // min-h-screen hataya aur padding adjust ki
