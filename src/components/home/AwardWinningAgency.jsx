...
export default function AboutSection() {
  ...
  return (
    <section className="w-full py-20 lg:py-32 overflow-hidden font-['Montserrat',ui-sans-serif,system-ui,sans-serif] bg-white">
      <div className="max-w-[1400px] mx-auto px-6 lg:px-16">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 lg:gap-24">
          ...
          <div className="lg:col-span-7 flex flex-col gap-10">
            ...
            {/* Stats Grid */}
            <FadeUp delay={0.2}>
              <div className="grid grid-cols-2 lg:grid-cols-4 rounded-[24px] overflow-hidden border-[1.5px] border-[#E2E2DC] shadow-sm bg-white">
                {[
                  {
                    value: "3+",
                  ...
                  <div 
                    key={i} 
                    className={`relative p-8 border-r-[1.5px] border-[#F4F4F0] last:border-r-0 lg:border-b-0 lg:last:border-r-0 max-lg:border-b-[1.5px] max-lg:border-r-0`}
                  >
                    <div className="font-['Montserrat',ui-sans-serif,system-ui,sans-serif] text-[30px] md:text-[42px] font-bold leading-[1.1] tracking-[-0.02em] mb-2 text-[#6400A1]">
                      {s.value}
                    </div>
